var projectName = '安康学院新型冠状病毒肺炎疫情防控专题网站';
/**
 * 轮播图配置
 */
var swiper = {
...
var indexNav = [
    ...
    {
        name: '工作动态',
        url: './pages/gongzuodongtai/list.html'
    },
    {
        name: '通知公告',
    ...
    {
        name: '防治知识',
        url: './pages/xinwenguanzhu/list.html'
    },

]

var adminurl =  "http://localhost:8080/guanzhaungfeiyanfangkong/admin/dist/index.html#/login";
