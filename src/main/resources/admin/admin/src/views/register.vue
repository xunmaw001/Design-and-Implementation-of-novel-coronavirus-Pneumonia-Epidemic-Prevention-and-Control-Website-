<template>
    <div style="backgroundImage: url('/guanzhaungfeiyanfangkong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">安康学院新型冠状病毒肺炎疫情防控专题网站注册</h1>
